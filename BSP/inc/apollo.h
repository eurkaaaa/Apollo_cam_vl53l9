...
#include "stm32n6570_errno.h"
#include "apollo_error.h"

#ifdef __cplusplus
extern "C" {
#endif

/* I2C1 board definitions - 请按 apollo 板实际硬件调整下面宏 */
...
#define BUS_I2C1_SCL_GPIO_CLK_ENABLE()         __HAL_RCC_GPIOE_CLK_ENABLE()
#define BUS_I2C1_SCL_GPIO_CLK_DISABLE()        __HAL_RCC_GPIOE_CLK_DISABLE()
...
/* 默认引脚：PE5=SCL, PC1=SDA */
#define BUS_I2C1_SCL_PIN                       GPIO_PIN_5
#define BUS_I2C1_SDA_PIN                       GPIO_PIN_1
#define BUS_I2C1_SCL_GPIO_PORT                 GPIOE
...
#define BUS_I2C1_FREQUENCY  100000U /* 100 kHz */
#endif
