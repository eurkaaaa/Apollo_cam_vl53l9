...
static void *dummy_isp_iq_param_ptr = NULL;
#define ISP_IQParamCacheInit_VD66GY (*(void**)&dummy_isp_iq_param_ptr)
...
//  (void) ISP_IQParamCacheInit; /* unused */
  ret = ISP_Init(&((CMW_VD66GY_t *)io_ctx)->hIsp, ((CMW_VD66GY_t *)io_ctx)->hdcmipp, 0, &((CMW_VD66GY_t *)io_ctx)->appliHelpers, &ISP_IQParamCacheInit_IMX335);
  if (ret != ISP_OK)
  {
