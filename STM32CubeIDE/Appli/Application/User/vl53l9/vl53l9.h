 ...
 *******************************************************************************
 * @file    vl53l9.h
 * @brief   VL53L9 driver header file
 *******************************************************************************
 *
 ...
 * @{
 */
#define VL53L9_CORE_MAJOR (0U)
#define VL53L9_CORE_MINOR (8U)
#define VL53L9_CORE_PATCH (1U)
/** @} */
 ...
 * @note The device does not send IBI notifications when configured in manual mode (nevertheless interrupts are raised)
 * @return See @ref VL53L9_ERROR
 */
