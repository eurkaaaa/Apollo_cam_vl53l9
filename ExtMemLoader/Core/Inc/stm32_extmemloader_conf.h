...
#define	STM32EXTLOADER_DEVICE_NAME            "Custom_Memory_Loader"
...
#define	STM32EXTLOADER_DEVICE_SECTOR_NUMBERS  0x8000
#define	STM32EXTLOADER_DEVICE_SECTOR_SIZE     0x1000
